  ...
  return <div className="wrapper clear">
    <header className="d-flex justify-between align-center p-40">
      ...
      <ul className="d-flex">
        ...
        <li className="mr-35">
          <img width={21} height={19} src="/img/heart.png" />
        </li>
        <li>
          <img width={21} height={19} src="/img/user.svg" />
        </li>
      </ul>
    </header>
    ...
    <div className="content p-40">
      ...
      <div className="d-flex">
        ...
        <div className="card">
          <img width={133} height={112} src="/img/sneakers/NikeAir.jpg" alt="Sneakers" />
          <h5>Man sneakers Jordan Air Jordan 11</h5>
          <div className="d-flex justify-between align-center ">
            <div className="d-flex flex-column " >
              <span>Price: </span>
        ...
        <div className="card">
          <img width={133} height={112} src="/img/sneakers/NikeBazer.jpg" alt="Sneakers" />
          <h5>Man sneakers Jordan Air Jordan 11</h5>
          <div className="d-flex justify-between align-center ">
            <div className="d-flex flex-column " >
              <span>Price: </span>
        ...
        <div className="card">
          <img width={133} height={112} src="/img/sneakers/NikeBlazer.jpg" alt="Sneakers" />
          <h5>Man sneakers Jordan Air Jordan 11</h5>
          <div className="d-flex justify-between align-center ">
            <div className="d-flex flex-column " >
              <span>Price: </span>
